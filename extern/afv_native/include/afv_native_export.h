...
#ifndef AFV_NATIVE_EXPORT_H
#define AFV_NATIVE_EXPORT_H

#ifdef AFV_NATIVE_STATIC_DEFINE
#  define AFV_NATIVE_EXPORT
#  define AFV_NATIVE_NO_EXPORT
#else
#  ifndef AFV_NATIVE_EXPORT
#    ifdef afv_native_EXPORTS
        /* We are building this library */
#      define AFV_NATIVE_EXPORT __attribute__((visibility("default")))
#    else
...
#  define AFV_NATIVE_DEPRECATED_EXPORT AFV_NATIVE_EXPORT AFV_NATIVE_DEPRECATED
#endif
