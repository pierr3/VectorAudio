...
submodules_licenses = [['afv-native', os.path.join('extern', 'afv-native', 'COPYING.md')], ['ImGui', os.path.join('extern', 'imgui', 'LICENSE.txt')], ['Platform Folders', os.path.join('extern', 'PlatformFolders', 'LICENSE')]]
